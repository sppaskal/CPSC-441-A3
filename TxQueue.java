 ...
 * A node item is inserted into the queue based on segment sequence number, while items are ALWAYS removed from the 'head' of the queue. 
 * Neverteless, for the sender, a new node is always added at the end. The implementation is generic to incorporate receiver side queue.
